package com.bw.myapplication.mq.mqactivity;
...
import com.bw.myapplication.mq.mqfragment.ImagesListsAdapter;
import com.bw.myapplication.mq.mqfragment.MyglideImageView;
...
//    }
    ...
    public void showBigPopup(int paramInt){
       ...
       // bigImagePopup.setAnimationStyle(R.style.photosWindowAnimation);
        ...
        RelativeLayout rl_back = (RelativeLayout)localView.findViewById(R.id.rl_back);
