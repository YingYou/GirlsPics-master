...
import com.bw.myapplication.ui.widgets.CorpDrawableBuilder;
                ...
                .into(new SimpleTarget<Bitmap>(Target.SIZE_ORIGINAL, Target.SIZE_ORIGINAL) {
                    ...
                    public void onResourceReady(Bitmap bitmap, GlideAnimation glideAnimation) {
                       ...
                       // bitmap.getWidth();
                        ...
                        int i = (int)(MQUtils.getScreenWidth(context) / f);


                        ViewGroup.LayoutParams layoutParams=ivImg.getLayoutParams();
                        layoutParams.height= MQUtils.getScreenHeight(context)*i;

                     //   ivImg.setLayoutParams(new PLA_AbsListView.LayoutParams(MQUtils.getScreenWidth(context), i));
