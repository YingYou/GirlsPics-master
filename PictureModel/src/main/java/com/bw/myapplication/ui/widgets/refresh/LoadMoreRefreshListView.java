package com.bw.myapplication.ui.widgets.refresh;
...
public class LoadMoreRefreshListView extends ListView implements OnScrollListener {
    ...
    public LoadMoreRefreshListView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoadMoreRefreshListView(Context context, AttributeSet attrs, int defStyleAttr) {
